...
| **NewLife.Office** | **91%** | **70** | **13** | **13** |
| NPOI | 65% | 42 | 20 | 34 |
| Open XML SDK | 100% | 96 | 0 | 0 |
| OfficeIMO | 55% | 40 | 13 | 43 |
| MiniWord | 20% | 15 | 4 | 77 |

> W09 实现后：制表位/上标下标/删除线/下划线样式/字符间距缩放/段落边框 共 5 个原依赖 RawXml 兜底的属性升级为显式建模，覆盖率从 86% 较 91%。Open XML SDK 覆盖率为 100% 是因为它直接操作底层 XML，理论上可以实现任何功能，但代价是极高的代码量。NewLife.Office 在“开筱即用的功能覆盖率”上排名 MIT 库第一。
...
1. **MIT 许可下功能最全**：86% 的常用功能覆盖率，远超其他 MIT/Apache 竞品

...
| 图表数据读取 | ❌ | ✅ | ✅ | ✅ | ✅ |
| 迷你图 (Sparklines) | ❌ | ✅ | ❌ | ❌ | ✅ |
| 条件格式图标集 (IconSet) | ❌（仅DataBar/ColorScale）| ✅ | ✅ | ✅ | ✅ |
| 条件格式自定义公式 | ❌ | ✅ | ✅ | ✅ | ✅ |
...
| 模块 | 功能 | 优先级 | 状态 |
|------|------|--------|------|
| M18 | 命名范围 (Defined Names) | 🔴高 | 待实现 |
| M19 | 结构化 Table 元素 | 🔴高 | 待实现 |
| M20 | 富文本/渐变填充/四边独立边框 | 🟡中 | 待实现 |
| M21 | 图表集成到 Writer/Reader | 🟡中 | 待实现 |
| M22 | 条件格式图标集/自定义公式 | 🟢低 | 待实现 |
| M23 | 文本旋转/缩进/分组大纲 | 🟢低 | 待实现 |
| M24 | 标签颜色/工作簿保护/calcPr | 🟢低 | 待实现 |
| M25 | xls 基础样式 (BiffWriter) | 🟢低 | 看情况 |
